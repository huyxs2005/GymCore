...
public class OrderInvoiceMailService {
    ...
    public void sendProductInvoice(InvoiceMailModel invoice) throws Exception {
        String subject = "GymCore Product Receipt - Order #" + invoice.orderId();
    ...
    private String buildPlainText(InvoiceMailModel invoice) {
        ...
        return """
                GymCore Product Receipt

                Hello %s,

                Thank you for your purchase at GymCore.
                Your payment has been confirmed successfully, and your order is now ready for front-desk pickup.
                ...
                Pickup Instructions
                - Bring Order ID %d to the GymCore front desk.
                - The receptionist will verify your receipt and release the order.
                - Please keep this email for order tracking and support.

                If you need assistance, reply to the official GymCore support channel used by the gym.

                This is an automated receipt from GymCore.
                """.formatted(
                ...
                <div style="margin:0; padding:24px; background:#f8fafc; font-family:Arial,sans-serif; color:#0f172a;">
                  <div style="max-width:820px; margin:0 auto; background:#ffffff; border:1px solid #e2e8f0; border-radius:24px; overflow:hidden; box-shadow:0 18px 40px rgba(15,23,42,0.08);">
                    <div style="padding:28px 32px; background:linear-gradient(135deg,#0f172a,#1e293b); color:#ffffff;">
                      ...
                      <h1 style="margin:10px 0 6px 0; font-size:28px; line-height:1.2;">Product Receipt</h1>
                      <p style="margin:0; color:#cbd5e1; font-size:14px;">Payment confirmed successfully. Please keep this receipt for front-desk pickup.</p>
                    </div>
                    ...
                    <div style="padding:8px 32px 0 32px;">
                      <div style="background:#ffffff; border:1px solid #e2e8f0; border-radius:18px; padding:18px 20px;">
                        <div style="font-size:12px; color:#64748b; text-transform:uppercase; letter-spacing:1.2px; margin-bottom:12px;">Customer Details</div>
                        <div style="color:#0f172a; font-size:14px; line-height:1.8;">
                          <div><strong>Full Name:</strong> %s</div>
                    ...
                    <div style="padding:0 32px 24px 32px;">
                      <div style="background:#ecfdf5; border:1px solid #bbf7d0; border-radius:18px; padding:18px 20px; color:#14532d;">
                        <div style="font-size:12px; text-transform:uppercase; letter-spacing:1.2px; margin-bottom:10px; font-weight:700;">Pickup Instructions</div>
                        <div style="font-size:14px; line-height:1.8;">
                          <div>Bring <strong>Order ID #%d</strong> to the GymCore front desk.</div>
                          <div>The receptionist will verify your receipt and release your products.</div>
                          <div>Please keep this email for order tracking and support.</div>
                        </div>
                      </div>
                    </div>

                    <div style="padding:20px 32px 28px 32px; border-top:1px solid #e2e8f0; color:#64748b; font-size:12px; line-height:1.7;">
                      <div>This is an automated receipt from GymCore.</div>
                      <div>Please keep this invoice code and Order ID for support, order tracking, and front-desk pickup.</div>
                    </div>
                  </div>
                </div>
                """.formatted(
