    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {posts.map((post) => (
            <div
              ...
              className="bg-[rgba(18,18,26,0.92)] rounded-2xl shadow-sm border border-white/10 overflow-hidden group transition-[transform,opacity,box-shadow,background-color,border-color,color] hover:shadow-md hover:-translate-y-1"
            >
              <div className="relative h-48 overflow-hidden">
                ...
                {post.IsClaimed === 1 && (
                  <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-[2px] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="bg-[rgba(18,18,26,0.9)] text-white px-4 py-2 rounded-xl font-bold text-sm flex items-center gap-2 shadow-xl">
              ...
              <div className="p-5">
                ...
                <h3 className="font-bold text-white text-lg mb-2 group-hover:text-gym-600 transition-colors line-clamp-1">
                  {post.Title}
                </h3>
                ...
                <button
                  ...
                  className={`w-full py-2.5 px-4 rounded-xl font-bold text-sm transition-[transform,opacity,box-shadow,background-color,border-color,color] duration-200 flex items-center justify-center gap-2
                    ${post.IsClaimed === 1
          ...
          {posts.length === 0 && (
            <div className="col-span-full py-16 text-center bg-[rgba(18,18,26,0.92)] rounded-2xl border border-dashed border-white/10">
              <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4">
                <Ticket className="text-slate-300" size={32} />
              </div>
              <h3 className="text-white font-bold">No active promotions</h3>
              <p className="text-zinc-500 text-sm mt-1">Check back later for exclusive fitness offers!</p>
            </div>
          )}
        </div>
      )}
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-[rgba(18,18,26,0.92)] rounded-3xl shadow-2xl max-w-sm w-full overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="relative h-32 bg-gym-600 flex items-center justify-center">
              ...
              <div className="w-20 h-20 bg-[rgba(18,18,26,0.92)] rounded-full flex items-center justify-center shadow-lg transform -translate-y-2">
                <Gift size={40} className="text-gym-600 animate-bounce" />
              </div>
            </div>
            <div className="px-8 pb-8 pt-4 text-center">
              <h2 className="text-2xl font-black text-white mb-2">Claim Successful!</h2>
