...
describe('coachBookingApi', () => {
  ...
  it('covers customer/coach/admin endpoint wrappers for path correctness', async () => {
    ...
    await coachBookingApi.cancelCoachSession(19, { cancelReason: 'coach unavailable' })
    ...
    expect(apiClient.patch).toHaveBeenCalledWith('/v1/coach/pt-sessions/19/cancel', { cancelReason: 'coach unavailable' })
